...
void main_main ()
{
    ...
    // inputs parameters
    {
        ...
        //“each grid is no longer than max_grid_size in that direction”
        ...
        //0 = periodic,2 = homogeneous Neumann (zero flux),
    ...
    //Dim3 lobound = lbound(geom.Domain());     

    //Dim3 hibound = ubound(geom.Domain());
    ...
    {
        MultiFab::Copy(phi_old, phi_new, 0, 0, Ncomp, Nghost);
